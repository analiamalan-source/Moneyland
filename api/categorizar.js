...
esPagoTarjeta debe ser true SOLO cuando el movimiento es un pago/traspaso desde la cuenta bancaria para saldar el resumen de una tarjeta de crédito. Ejemplos: "PAGO OCA", "PAGOTARD", "PAGO TARD", "TRASPASO A PAGO OCA", "DEB. VARIOS VISA-ILINK", "PAGO TARJETA", o cualquier descripción que contenga "TARD" o "TARJETA" en el contexto de un pago de resumen. Esos pagos quedan pendientes de conciliación con el resumen de la tarjeta y NO se registran como gasto.
